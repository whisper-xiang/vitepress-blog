...
export const NAV_DATA: NavData[] = [
  ...
  // },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: '区块链技术与应用',
        desc: '北京大学肖臻老师《区块链技术与应用》公开课',
        link: 'https://www.bilibili.com/video/av37065233/?p=15&vd_source=ca8dc73cb080be3886313b126b8356d3',
      },
      {
        icon: 'https://openbuild.xyz/favicon-16x16.png',
        title: 'open build社区',
        desc: 'Start Your Web3 Career with OpenBuild',
        link: 'https://openbuild.xyz/learn/challenges?page=2',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://smzdk.top/ico/favicon.png',
        title: '什么值得看',
        desc: '发现当下正在发生的有趣事',
        link: 'https://smzdk.top/#/',
      },
    ],
  },
]
